...
function Card({ form, authorImage }) {
  //destructurin de props
  const { name, desc, slogan, repo, demo, autor, job } = form; //destructuring de form(objeto)
  ...
  return (
    <section className="preview">
      <div className="card">
        ...
        <div className="cardHelement">
          <div className="card__author">
            <div className="card__authorPhoto">
              <img src={authorImage || Image} />
            </div>
